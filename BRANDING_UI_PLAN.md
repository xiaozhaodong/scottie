...
这不是法律上的商标清除意见。WIPO 和 USPTO 都要求按目标市场、相似性以及商品/服务关联性做完整检索；本次结果只能说明快速检查中没有看到明显冲突，不能保证全球或特定国家可注册、可使用。
...
> 单独叫 Scottie 不等于当然侵权；一旦挂上 Star Trek 隐喻，就会增加明确指涉 Paramount 角色的混淆风险。公开发布或申请商标前，仍应在目标市场做正式清查。
