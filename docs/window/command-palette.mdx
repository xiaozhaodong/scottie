...
Every action Scottie can perform is in here, whether or not it has a keybinding —
...
<Frame caption="Placeholder — screenshot: the command palette open over a terminal, grouped results">
  <img src="/images/placeholder.svg" alt="The Scottie command palette" />
</Frame>
...
If no agent is running, Scottie says so rather than typing into your shell.
