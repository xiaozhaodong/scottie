...
<Frame>
  <img src="/images/hero.webp" alt="Scottie showing a sidebar of agent sessions across several repositories" />
</Frame>

Scottie is a terminal you can leave running. Close the window, reboot the machine,
...
<CardGroup cols={2}>
  <Card title="Sessions that outlive the app" icon="power-off" href="/getting-started/concepts">
    A background server owns your shells, not the window. Quit Scottie and your
...
[`scripts/bench/`](https://github.com/xiaozhaodong/scottie/tree/main/scripts/bench).
...
<CardGroup cols={3}>
  ...
  <Card title="Issues" icon="github" href="https://github.com/xiaozhaodong/scottie/issues">
    Bugs and feature requests.
  </Card>
  <Card title="Changelog" icon="list" href="https://github.com/xiaozhaodong/scottie/blob/main/CHANGELOG.md">
