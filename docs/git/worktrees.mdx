...
working tree. A git worktree is the fix, and Scottie makes it a single dialog.
...
Confirm and Scottie creates the worktree, opens a tab in it, and starts a shell
