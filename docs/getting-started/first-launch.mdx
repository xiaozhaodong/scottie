...
Open Scottie and you get a window with one tab and one shell, and a tab sidebar
...
<Frame caption="Placeholder — screenshot: the Settings window, Appearance section">
  <img src="/images/placeholder.svg" alt="Scottie Settings" />
</Frame>

## 1. Pick a theme

**Settings → Appearance → Theme.** Fifteen themes ship built in — Light, One
Light, Catppuccin Latte, Rosé Pine Dawn, April, Dark, Dracula, Harbor, One Dark
Pro, Rosé Pine, Catppuccin Macchiato, Catppuccin Mocha, Gruvbox Dark, Nord, and
Tokyo Night. The default is **Light**.

Turn on **Sync with system** to pick a light theme and a dark theme separately;
Scottie then follows the OS appearance live.
...
**Start in** decides what a *fresh* shell opens in: Scottie's launch directory
...
**Settings → Agents.** Scottie detects 19 coding CLIs by process name on its own —
...
Your shells, builds, and agent turns keep going, and reopening Scottie reattaches
to them.
...
**Settings → Window & Tabs → Notifications.** By default Scottie posts a desktop
