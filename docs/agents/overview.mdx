---
title: "Coding agents"
description: "What Scottie does around Claude Code, Codex, TraeCode, and 19 others — without ever wrapping them."
---

Scottie recognises coding agents running in a pane and builds around them. It does
not wrap them, proxy them, or replace their interface: the agent you start is
the agent you get, running in a normal PTY, with its own UI. Scottie adds the
...
<Frame caption="Placeholder — screenshot: a sidebar of agent sessions across several repos, each with a brand avatar and status dot">
  <img src="/images/placeholder.svg" alt="Agent sessions in the Scottie sidebar" />
</Frame>
...
itself, over a channel Scottie installs into that agent's configuration. It powers
