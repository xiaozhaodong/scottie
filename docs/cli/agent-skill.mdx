...
description: "Teaching a coding agent to use Scottie properly — including when not to."
---
...
```bash
npx skills add xiaozhaodong/scottie
```

The source lives at
[`skills/tty7/`](https://github.com/xiaozhaodong/scottie/tree/main/skills/tty7) in the
...
<Note>
  This is the only skill Scottie has — nothing in **Settings → Agents** installs
...
shortest description of how to use Scottie as a job runner. Start with the
