---
title: "The Scottie command"
description: "Driving the workbench from a script, a Makefile, or another agent."
---

`tty7` is a thin, non-interactive client of the Scottie server. Every verb runs and
...
<Note>
  ...
  passes `--keep` to cargo, not to Scottie.
</Note>
...
If you are not inside a Scottie pane there is nothing to split, so make your own
place to work:
