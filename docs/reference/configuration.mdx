...
| `show_pane_title` | bool | `true` | Name each pane along its top edge in a split tab: the title the program set, the agent working in it, or the folder it sits in. Costs about a line and a half of grid. |
