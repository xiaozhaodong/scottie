...
The app window logs separately, and a GUI started from the Dock inherits no
shell environment. Set `"log_level": "info"` in `config.json`, restart Scottie,
and read `tty7.log` beside it.
