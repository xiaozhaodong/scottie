---
title: "Themes"
description: "Fifteen built-ins, your own YAML themes, iTerm2 imports, and a colour editor."
---
...
| Light | Dark |
|---|---|
| Light *(default)* · One Light · Catppuccin Latte · Rosé Pine Dawn · April | Dark · Dracula · Harbor · One Dark Pro · Rosé Pine · Catppuccin Macchiato · Catppuccin Mocha · Gruvbox Dark · Nord · Tokyo Night |

<Frame caption="Placeholder — screenshot: the theme picker with light and dark sections">
  <img src="/images/placeholder.svg" alt="The Scottie theme picker" />
</Frame>

## Following the system

Turn on **Sync with system** and pick a theme for each appearance. Scottie follows
...
Drop an `.itermcolors` file into the themes folder and Scottie reads it directly —
no conversion step.

<Note>
  A theme file Scottie could not load is listed in Settings under **Not loaded from
