...
That releases <kbd>⌃ R</kbd> and nothing else — <kbd>↑</kbd> still walks Scottie's
...
history written outside Scottie shows up immediately.

The per-row extras — when you last ran it, whether it failed — come from a small
file Scottie keeps alongside it, filled in as you run things. A command Scottie has
