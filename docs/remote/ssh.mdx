...
clipboard on the machine running Scottie with the OSC 5522 clipboard protocol.
...
if len(data) > 16 * 1024 * 1024:
    raise SystemExit("image exceeds Scottie's 16 MiB clipboard limit")
...
5522 request id and wait for Scottie's `DONE`, `EPERM`, `EINVAL`, or `ENOSYS`
